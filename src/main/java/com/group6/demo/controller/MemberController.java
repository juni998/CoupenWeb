...
public class MemberController {
    ...
    public String findId(String email, Model model) {
        ...
        return "/home/login/MyPage"; // json
    }

    // 이메일로 아이디 찾기 -> 아이디 확인 (매핑주소, 리턴주소 변경예정)
    @GetMapping("/findIdChange/{memberId}")
    public String IdInfo(@PathVariable("memberId") Long memberId, Model model) {
    ...
    @PostMapping("/findPw")
    public String findPw(@RequestParam String account, Model model,RedirectAttributes redirectAttributes) {
    ...
    @GetMapping("asdf")
    @ResponseBody
    public Long asdf(Member member){
